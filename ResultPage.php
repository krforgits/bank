      ...
      $sql = "Select * from accountdetails where accID='$PAYER_ID'";       
          ...
          if($result = $conn->query($sql2)){
           ...
           if($conn->query($updatepayee)==true){
            ...
            $Uppayer ="Insert into PB$row1[sno] (type, des, amt, balance, time) values ('debit','Trf to $row2[name]','$AMOUNT','$PayerCurrentBalance','$date')";
            ...
            $Uppayee ="Insert into PB$row2[sno] (type, des, amt, balance, time) values ('credit','Trf from $row1[name]','$AMOUNT','$PayeeCurrentBalance','$date')";
